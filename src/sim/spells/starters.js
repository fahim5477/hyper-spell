...
import { emitParticle, spawnParticles, addShake, doFlash } from '../fx.js';
...
export const STARTERS = {
  ...
  gust: {
    ...
    cast(p) {
      ...
      for (let i = 0; i < 14; i++) {
        emitParticle({ kind: 'spark', x: x + dir.x * 20, y: y - 6 + dir.y * 20 + rand(-10, 10), vx: dir.x * rand(6, 14), vy: dir.y * rand(6, 14) + rand(-1, 1), life: 18, maxLife: 18, color: '#d7f5ef', r: 2 });
      }
    },
  },
  lightning: {
